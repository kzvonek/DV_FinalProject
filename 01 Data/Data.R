...
dfSTATETOTALS <- data.frame(fromJSON(getURL(URLencode('129.152.144.84:5001/rest/native/?query="select STATE, NUM_FIRMS, NUM_ESTABLISHMENTS, EMPLOYMENT, PAYROLL from STATETOTALS where STATE<>\'null\'"'),httpheader=c(DB='jdbc:oracle:thin:@129.152.144.84:1521:ORCL', USER='C##cs329e_nh5797', PASS='orcl_nh5797', MODE='native_mode', MODEL='model', returnDimensions = 'False', returnFor = 'JSON'), verbose = TRUE)))
